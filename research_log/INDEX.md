...
- EXP-015 — Matched-protocol production: full-decoder arm COMPLETE (9200 steps, val_loss bottomed at step 750/0.562, plateaued 0.56-0.65 through step 9200); LoRA arm RUNNING (truncated to 3700 steps per DEC-012, step 375 as of last check, val_loss still improving, no plateau). WER evaluation of both arms deliberately deferred until LoRA completes (avoids GPU contention risk after the ISS-016 OOM)
