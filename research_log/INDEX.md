...
- EXP-015 — Matched-protocol production: full-decoder (9200 steps) 18.19% dev / 18.73% test WER; LoRA-truncated (3700 steps) 19.83% dev / 20.62% test WER — full-decoder beats LoRA by 1.89pp under fully matched conditions. LoRA-full (9200 steps, checkpoints step-aligned to full-decoder's) running, ~50% done as of last check
